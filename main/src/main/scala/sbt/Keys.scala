...
object Keys {
  ...
  val scala29 = SettingKey[String]("scala29", "The version of Scala 2.9.x to use", BSetting)
  val scala210 = SettingKey[String]("scala210", "The version of Scala 2.10.x to use", BSetting)
  val scala211 = SettingKey[String]("scala211", "The version of Scala 2.11.x to use", BSetting)
  val scala212 = SettingKey[String]("scala212", "The version of Scala 2.12.x to use", BSetting)
  val scala213 = SettingKey[String]("scala213", "The version of Scala 2.13.x to use", BSetting)
  val scala214 = SettingKey[String]("scala214", "The version of Scala 2.14.x to use", BSetting)
  val scala215 = SettingKey[String]("scala215", "The version of Scala 2.15.x to use", BSetting)
